...
--   SHA-256:    eb8ec5d3d2a638f9c083476ca27560ac5304a641ab825f817148039f3379b1c4
--   pell git:   2b77ce0
--   Target:     Oracle 23
--   Schema:     orders
...
CREATE OR REPLACE PACKAGE BODY orders.fulfillment AS
  ...
  BEGIN
    ...
    BEGIN
      ...
      log.info(('added line ' || l_new_line_id || ' to order ' || p_order_id));
      COMMIT;
      l_committed_0 := TRUE;
