-- ======================================================================
-- Generated by pell 0.0.1 from module fulfillment
--   Source:     compiler/examples/07_full.pell
--   SHA-256:    6091c12bef8c9bb7bf2cc9540d1f79b6d84d035a1eed8a8e26359361bf0b9f39
--   pell git:   dd8ab63
--   Target:     Oracle 23
--   Schema:     orders
...
-- Additions to pell_runtime for module fulfillment:
...
CREATE OR REPLACE PACKAGE BODY orders.fulfillment AS
  ...
  BEGIN
    ...
    BEGIN
      SAVEPOINT pell_sp_0;  -- @ 07_full.pell:48
      BEGIN
        select id, customer_id, status, total
      INTO l_ord
    ...
    EXCEPTION
      WHEN OTHERS THEN
        IF NOT l_committed_0 THEN ROLLBACK TO pell_sp_0; END IF;  -- @ 07_full.pell:48
        RAISE;
    END;
